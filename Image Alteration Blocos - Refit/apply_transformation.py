...
def apply_transformations(
    ...
    Args:
        ...
        params (torch.Tensor): The transformation parameters tensor of shape (10,).

    Returns:
        torch.Tensor: The transformed image tensor.
    """
    rotation, crop_left, crop_top, crop_right, crop_bottom, brightness, contrast, red_adjust, green_adjust, blue_adjust = params
    ...
    # Resize back to original size if cropped or rotated
